...
namaowner = 'Sean-Chan' 
namabot = 'Sean Bot' 
nomorbot = '62895411143170'//GANTI NOMOR BOT LOE
nomerowner = '62895411143170'//‼️❗‼️ GANTI SESUAI CONTOH!!
nomerowner2 = '14106604540' //‼️❗‼️ GANTI SESUAI CONTOH!!
prefix = '.'
limitawal = "10"
gamewaktu = '30'
hargalimit = '500'
...
sosmedowner = 'Follow IG owner: seti._awan'
...
async function starts() {
	        ...
	        fs.existsSync('./session.json') && farid.loadAuthInfo('./session.json')
	        farid.on('connecting', () => {
		    start('2', '50%')		   
        	})
	        farid.on('open', () => {	        
  	  	...
  	  	console.log(chalk.bgHex('#FFDF00').underline(color('JANGAN LUPA FOLLOW','black')))
  	  	console.log(chalk.bgHex('#FFDF00').underline(color('YT : Gak Ada','black')))
  	  	console.log(chalk.bgHex('#FFDF00').underline(color('IG : @seti._awan','black')))
  	  	console.log(chalk.bgHex('#FFDF00').underline(color('BUG ATAU APA SILAHLAN CHAT 62895411143170','red')))
  	  	})         
            ...
            fs.writeFileSync('./session.json', JSON.stringify(farid.base64EncodedAuthInfo(), null, '\t'))
//▬▭▬▭⸨ WELCOME ⸩▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
	...
	try {
		...
		if (urutan_pesan === 5000) {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
               	const ftoko = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./database/image/Farid.jpeg') }, "title": `SEAN BOTZ`, "productImageCount": 9999 }, "businessOwnerJid": `0@s.whatsapp.net`}}}
	            const muz1 = {
                  key: {
			fromMe: false, 
...
addKoinUser('62895411143170@s.whatsapp.net', fee)
...
farid.sendMessage(from, wew, image, {thumbnail:fs.readFileSync('./database/image/gambar.jpeg'), quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {}) }, message: { 'productMessage': { 'product': { 'productImage':{ 'mimetype': 'image/jpeg', 'jpegThumbnail': fs.readFileSync('./database/image/Farid.jpeg') }, 'title': `⊳ SEAN BOTZ ⊲`, 'productImageCount': 9999 }, 'businessOwnerJid': `0@s.whatsapp.net`}}}, caption: muz})
break
case 'menucek':
case 'cekmenu':
if (!isRegister) return reply( ind.noregis())
...
break
					...
					if (pesan.length > 500) return farid.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 500 Teks', msgType.text, {quoted: mek})
					...
					if (cfrr.length > 500) return farid.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', msgType.text, {quoted: mek})
					var nomor = mek.participant
					const ress = `*[REQUEST FITUR]*\nNomor : @${nomor.split("@s.whatsapp.net")[0]}\nPesan : ${cfrr}`
			     	      ...
			     	      farid.sendMessage('62895411143170@s.whatsapp.net', options, text, {quoted: mek})
 ...
 case 'memegenerator':
		...
		case 'leave':
                 ...
                 if (!isRegister) return reply( ind.noregis())
					...
					setTimeout( () => {
					farid.updatePresence(from, Presence.composing) 
					farid.sendMessage(from, 'Bye🗣', text) // ur cods
					}, 0)
					break
		case 'bc': 
					if (!isOwner) return reply(ind.ownerb()) 
		...
		case 'kick':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += ` *_ASEK DAPAT MANGSA OTW MENGKICK_*
 🤭 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						...
						mentions(`*_ASEK DAPAT MANGSA OTW MENGKICK_*
...
/*-----------------------------------------------------[ STICKER MENU ]--------------------------------------------------------------*/    
		...
		case 'makequote':
                  ...
                  var gh = body.slice(12)
                   ...
                   case 'createktp':
                    if (!isPrem) return reply(ind.prem())                
                    if (args.length == 0) return reply(`> *USAGE :* ${prefix + command} nik|provinsi|kabupaten|nama|tempat, tanggal lahir|jenis kelamin|jalan|rt/rw|kelurahan|kecamatan|agama|status nikah|pekerjaan|warga negara|berlaku sampai|url_image\n\n────────────\n\n> *EXAMPLE :* ${prefix + command} 6289643314604|bumipertiwi|fatamorgana|SEAN BOT|mars, 99-99-9999|belum ditemukan|jl sukarno|999/999|turese|imtuni|alhamdulillah islam|jomblo kack|mikirin dia|indo ori no kw|hari kiamat|https://i.ibb.co/QbCC3Q7/0438dd9a28d2.jpg\n\nNOTE : UNTUK MENGUBAH GAMBAR MENJADI URL BISA LEWAT https://imgbb.com`)
